...
public class MemberDto {
	...
	private String member_name, member_id, member_pw, member_nick,
	member_phone, member_auth, member_join_date, member_login_date;
	...
	public String toString() {
		return "MemberDto [member_no=" + member_no + ", member_point=" + member_point + ", member_name=" + member_name
				+ ", member_id=" + member_id + ", member_pw=" + member_pw + ", member_nick=" + member_nick
				+ ", member_phone=" + member_phone + ", member_auth=" + member_auth + ", member_join_date="
				+ member_join_date + ", member_login_date=" + member_login_date + "]";
	}
